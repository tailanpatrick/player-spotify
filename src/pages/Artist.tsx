...
const Artist = () => {
  ...
  const artistSongs = songsArray.filter((song: Song) => song.artist === artist.name) as Song[];
  ...
  return (
    <div className="rounded-xl mt-0 mr-0 mb-4">
      ...
      <div className={`bg-black bg-opacity-25 flex items-end p-6 h-[30svh] md:h-[50svh] bg-cover bg-[40%_40%]`}
        ...
        <h2 className="text-[36px] md:text-8xl md:leading-[100%] text-shadow-md">{artist.name}</h2>
      </div>
